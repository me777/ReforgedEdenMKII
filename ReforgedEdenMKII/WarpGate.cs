...
namespace ReforgedEdenMKII
{
    internal class WarpGate
    {
        ...
        internal void Update(ReforgedEdenMKII mod)
        {
        ...
        internal void OnGSL(ReforgedEdenMKII mod, List<GlobalStructureInfo> gsl)
        {
        ...
        internal void OnPlayerInfo(ReforgedEdenMKII mod, PlayerInfo pi)
        {
        ...
        private void MessagePlayerList(ReforgedEdenMKII mod, List<int> pids, string message)
        {
            foreach (var pid in pids)
            {
        ...
        private void SendActivationQuery(ReforgedEdenMKII mod, int entityId)
        {
