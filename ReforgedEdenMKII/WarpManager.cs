...
namespace ReforgedEdenMKII
{
    internal static class WarpManager
    {
        ...
        internal static void WarpEntitiesAsync(ReforgedEdenMKII mod, List<int> playerIds, List<int> entityIds, string playfield)
        {
        ...
        internal static void OnPlayfieldLoaded(ReforgedEdenMKII mod, string playfield)
        {
